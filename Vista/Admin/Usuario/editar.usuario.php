...
$resultado= $control->Buscar($_GET["idPersona"]);
		...
		<div class="container">
			<form class="contact100-form validate-form" method="POST" style="width: 70%;" id="formRegistrar">
				...
				<div class="wrap-input100 validate-input" data-validate = "El documento es requerido">
					<input id="documento" class="input100" type="number" name="idpersona" value="<?php echo $resultado->idPersona; ?>" placeholder="Digite el documento" disabled min="1">
				...
				<div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate="El nombre es obligatorio">
					<input id="first-name" class="input100" type="text" name="nombres" placeholder="Nombres" value="<?php echo $resultado->nombre; ?>">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>
				<div class="wrap-input100 rs2-wrap-input100 validate-input" data-validate="Type last name">
					<input class="input100" type="text" name="apellidos" placeholder="Apellidos" value="<?php echo $resultado->apellidos; ?>">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div></label>
				...
				<div class="wrap-input100 validate-input" data-validate = "Correo electrónico es requerido: ejemplo@correo.com">
					<input id="email" class="input100" type="text" name="correo" placeholder="Ej. ejemplo@correo.com" value="<?php echo $resultado->correo; ?>">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>

				<label class="label-input100" for="contraseña">Contraseña<span style="color:red;"> *</span></label>
				<div class="wrap-input100 validate-input" data-validate="Type first name">
					<input id="contraseña" class="input100" type="password" name="password" placeholder="Contraseña" value="<?php echo $resultado->password; ?>" disabled>
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>

				<label class="label-input100" for="dir">Direccion y teléfono <span style="color:red;"> *</span></label>
				<div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate="Type first name">
					<input id="dir" class="input100" type="text" name="direccion" placeholder="Dirección" value="<?php echo $resultado->direccion; ?>">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>
				<div class="wrap-input100 rs2-wrap-input100 validate-input" data-validate="Type last name">
					<input class="input100" type="number" maxlength="10" name="telefono" placeholder="Teléfono" value="<?php echo $resultado->telefono; ?>">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>
				
				<div class="container-contact100-form-btn">
				<input type="submit" class="btn btn-secondary" value="Actualizar" name="Actualizar" id="Actualizar" style='width:700px; height:38px'>
				</div>
			</form>
				</div>
			</div>
...
if (isset($_POST["Actualizar"])) {
    $usuario->__SET('idPersona',$_GET["idPersona"]);

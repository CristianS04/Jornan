...
$resultado= $control->BuscarCotizacion($_GET["idCotizacion"]);
		...
		<div class="container" >
			<form class="contact100-form validate-form" method="POST" style="width: 70%;" id="formRegistrar">
				...
				<div class="wrap-input100  validate-input" data-validate="El nombre del producto es obligatorio">
					<input id="first-name" class="input100" type="text" name="nombreProducto" placeholder="Nombre del producto" value="<?php echo $resultado->nombreProducto; ?> ">
				...
				<div class="wrap-input100 validate-input" data-validate = "La fecha es obligatoria">
					<input id="email" class="input100" type="text" name="fecha" placeholder="YYYY/MM/DD" value="<?php echo $resultado->fecha; ?> ">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>
				...
				<div class="wrap-input100  validate-input" data-validate="Si no hay descuento escriba 0">
					<input id="contraseña" class="input100" type="text" name="descuento" placeholder="Descuento" value="<?php echo $resultado->descuento; ?> ">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>
				...
				<div class="wrap-input100  validate-input" data-validate="El total es obligatorio">
					<input id="dir" class="input100" type="text" name="total" placeholder="Total" value="<?php echo $resultado->total; ?> ">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>
...
if (isset($_POST["Actualizar"])) {
    $cotizacion->__SET('idCotizacion',$_GET["idCotizacion"]);
    ...
    if($control->Actualizarco($cotizacion)){

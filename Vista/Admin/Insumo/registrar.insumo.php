...
$control2= new ProveedorController();
		...
		<div class="container" >
			<form class="contact100-form validate-form" method="POST" style="width: 70%;" id="formRegistrar">
                ...
                <select  name="idCotizacion" class="form-control">
                    ...
                    <?php
                         foreach ($control2->ConsulProv() as $fila) {
                         echo "<option value='".$fila->__GET('nombre')."'>".$fila->__GET('nombre')."</option>";
                         };
                     ?>
                    </select>
				...
				<div class="wrap-input100 validate-input" data-validate = "El nombre es obligatorio">
					<input id="email" class="input100" type="text" name="nombre" placeholder="Nombre">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>

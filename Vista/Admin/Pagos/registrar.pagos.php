...
$pago = new pagoModel();
$control2= new CotizacionController();
$cott= new CotizacionModel();
...
<div class="container-contact100" style=" background: #FFFBF6;">
		<div class="container" >
			<form class="contact100-form validate-form" method="POST" style="width: 70%;" id="formRegistrar">
				...
				<div class="wrap-input100 validate-input" data-validate = "El id de la cotización es obligatorio">
                <select  name="idCotizacion" class="form-control">
                    <option value="0">Seleccione una opcion</option>
                    <?php
                         foreach ($control2->ConsulCot() as $fila) {
                         echo "<option value='".$fila->__GET('idCotizacion')."'>".$fila->__GET('idCotizacion')."</option>";
                         };
                     ?>
                    </select>
				...
				<div class="wrap-input100  validate-input" data-validate="Dirección es obligatoria">
					<input id="dirDom" class="input100" type="text" name="dirDom" placeholder="Dirección Domicilio" >
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate = "Recargo es obligatoria">
					<input id="recDom" class="input100" type="number" name="recDom" placeholder="Recargo Domicilio">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate = "Monto es obligatorio">
					<input id="monto" class="input100" type="number" name="monto" placeholder="Monto" >
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>
...
if (isset($_POST["registrar"])) {
	...
	$pago->__SET('monto',$_POST["monto"]);
	$pago->__SET('estado',1);

    if($control->Insertar($pago)){

...
<div class="limiter">
		<div class="container-table100"style=" background: #FFFBF6">
			<div class="wrap-table100">
              ...
              <th scope="column1"><center>Código Orden Producción</center> </th>
              <th scope="column2"><center>Fecha Inicio</center></th>
              <th scope="column3"><center>Fecha Final</center></th>
              <th scope="column4"><center>Estado</center></th>
              ...
              <th scope="column11">Eliminar</th>
                ...
                <td class="column1"><center><?php echo $fila->__GET('idOrdenProduccion'); ?></center></td>
                <td class="column2"><center><?php echo $fila->__GET('fechaInicio'); ?></center></td>
                <td class="column3"><center><?php echo $fila->__GET('fechaFinal'); ?></center></td>
                ...
                <th class="column6"><a class="btn btn-primary"  href="editar.orden.php?idOrdenProduccion=<?php echo $fila->idOrdenProduccion;?>">Editar</a></th>
                <th class="column7"><button class="btn btn-danger" href="eliminar.orden.php?idOrdenProduccion=<?php echo $fila->idOrdenProduccion;?>" >Eliminar</button></th>
								</tr> <?php endforeach; ?>

...
<div class="container-contact100" style=" background: #FFFBF6;">
		<div class="container" >
			<form class="contact100-form validate-form" method="POST" style="width: 70%;" id="formRegistrar">
				...
				<div class="wrap-input100 validate-input" data-validate = "El id de la orden es obligatorio">
                <input id="idOrden" class="input100" type="number" name="idOrden" placeholder="Id Orden Producción">
					<span class="focus-input100" style="border: 1px solid #000000" ></span>
				</div>
				
				

				<label class="label-input100" for="fecha">Fecha Inicio<span style="color:red;"> *</span></label>
				<div class="wrap-input100 validate-input" data-validate = "La fecha es obligatoria">
					<input id="fechaInicio" class="input100" type="date" name="fechaInicio" placeholder="YYYY/MM/DD">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>

                <label class="label-input100" for="fecha">Fecha Final<span style="color:red;"> *</span></label>
				<div class="wrap-input100 validate-input" data-validate = "La fecha es obligatoria">
					<input id="fechaFinal" class="input100" type="date" name="fechaFinal" placeholder="YYYY/MM/DD">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>



				<label class="label-input100" for="contraseña">Estado<span style="color:red;"> *</span></label>
				<div class="wrap-input100  validate-input" data-validate="ESTADOOOO">
					<input id="estado" class="input100" type="number" name="estado" placeholder="Descuento" min=1 max=100>
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>

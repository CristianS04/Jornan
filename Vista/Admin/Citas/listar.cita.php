...
<div class="limiter">
		<div class="container-table100"style=" background: #FFFBF6">
			<div class="wrap-table100">
              ...
              <th scope="column1"><center>idAgendaCita</center> </th>
              <th scope="column2"><center>TipoCita</center></th>
              <th scope="column3"><center>Documento</center></th>
              <th scope="column4"><center>Fecha</center></th>
              <th scope="column6"><center>HoraInicio</center></th>
              <th scope="column7"><center>HoraFin</center></th>
              <th scope="column8"><center>Dirección</center></th>
              <th scope="column9"><center>Estado</center></th>
              ...
              <th scope="column11">Eliminar</th>
                ...
                <td class="column1"><center><?php echo $fila->__GET('idAgendaCita'); ?></center></td>
                <td class="column2"><center><?php $tipo= $fila->__GET('idTipoCita');
                	if ($tipo==1) {
                    echo "Cotizacion";
                  }else {
                    echo "Instalacion";
                  } ?></center></td>
                <td class="column3"><center><?php echo $fila->__GET('idPersona'); ?></center></td>
                <td class="column4"><center><?php echo $fila->__GET('fecha'); ?></center></td>
                <td class="column4"><center><?php echo $fila->__GET('horaInicio'); ?></center></td>
                <td class="column4"><center><?php echo $fila->__GET('horaFin'); ?></center></td>
                <td class="column4"><center><?php echo $fila->__GET('direccion'); ?></center></td>
                ...
                <th class="column6"><a class="btn btn-primary"  href="editar.cita.php?idAgendaCita=<?php echo $fila->idAgendaCita;?>">Editar</a></th>
                <th class="column7"><button class="btn btn-danger" href="eliminar.cita.php?idAgendaCita=<?php echo $fila->idAgendaCita;?>" >Eliminar</button></th>
								</tr> <?php endforeach; ?>

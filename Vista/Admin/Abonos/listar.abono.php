...
<div class="limiter">
		<div class="container-table100"style=" background: #FFFBF6">
			<div class="wrap-table100">
              ...
              <th scope="column1"><center>idAbono</center> </th>
              <th scope="column2"><center>Fecha</center></th>
              ...
              <th scope="column5"><center>Eliminar</center></th>
                ...
                <td class="column1"><center><?php echo $fila->__GET('idAbono'); ?></center></td>
                <td class="column3"><center><?php echo $fila->__GET('fecha'); ?></center></td>
                <td class="column4"><center><?php echo $fila->__GET('valor'); ?></center></td>
                <th class="column6"><a class="btn btn-primary"  href="editar.abono.php?idAbono=<?php echo $fila->idAbono;?>">Editar</a></th>
                <th class="column7"><center><button class="btn btn-danger" href="eliminar.abono.php?idAbono=<?php echo $fila->idAbono;?>" >Eliminar</button></center></th>
								</tr> <?php endforeach; ?>

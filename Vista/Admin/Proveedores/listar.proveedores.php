...
<div class="limiter">
		<div class="container-table100"style=" background: #FFFBF6">
			<div class="wrap-table100">
              ...
              <th scope="column1"><center>idProveedor</center> </th>
              <th scope="column2"><center>Nombre</center></th>
              <th scope="column3"><center>Razon Social</center></th>
              <th scope="column3"><center>NIT</center></th>
              <th scope="column4"><center>Telefono</center></th>
              <th scope="column4"><center>Fax</center></th>
              <th scope="column4"><center>Direccion</center></th>
              <th scope="column4"><center>Representante Legal</center></th>
              <th scope="column4"><center>Tel Representante</center></th>
              ...
              <th scope="column6">Eliminar</th>
                ...
                <td class="column3"><center><?php echo $fila->__GET('razonSocial'); ?></center></td>
							  <td class="column5"><center><?php echo $fila->__GET('nit'); ?></center></td>
                <td class="column5"><center><?php echo $fila->__GET('telefono'); ?></center></td>
                <td class="column5"><center><?php echo $fila->__GET('fax'); ?></center></td>
                <td class="column5"><center><?php echo $fila->__GET('direccion'); ?></center></td>
                <td class="column5"><center><?php echo $fila->__GET('representanteLegal'); ?></center></td>
                <td class="column5"><center><?php echo $fila->__GET('telefonoRepresentante'); ?></center></td>
                <th class="column6"><a class="btn btn-primary"  href="editar.proveedor.php?idProveedor=<?php echo $fila->idProveedor;?>">Editar</a></th>
                <th class="column7"><button class="btn btn-danger" href="eliminar.proveedor.php?idProveedor=<?php echo $fila->idProveedor;?>" >Eliminar</button></th>
								</tr> <?php endforeach; ?>

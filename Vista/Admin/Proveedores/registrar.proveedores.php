		...
		<div class="container" >
			<form class="contact100-form validate-form" method="POST" style="width: 70%;" id="formRegistrar">
				...
				<div class="wrap-input100 validate-input" data-validate = "El nombre es requerido">
					<input id="documento" class="input100" type="text" name="nombre" placeholder="Digite el nombre" >
				...
				<div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate="La razón social es obligatoria">
					<input id="first-name" class="input100" type="text" name="razonSocial" placeholder="Razón Social">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>
				<div class="wrap-input100 rs2-wrap-input100 validate-input" data-validate="El NIT es obligatorio">
					<input class="input100" type="number" name="nit" placeholder="NIT">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div></label>
				...
				<div class="wrap-input100 validate-input" data-validate = "El telefono es obligatorio">
					<input id="email" class="input100" type="number" name="telefono" placeholder="Telefono">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>
				...
				<div class="wrap-input100  validate-input" data-validate="El fax es obligatorio">
					<input id="contraseña" class="input100" type="number" name="fax" placeholder="Fax">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>
				...
				<div class="wrap-input100  validate-input" data-validate="La dirección es obligatoria">
					<input id="contraseña" class="input100" type="text" name="direccion" placeholder="Dirección">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>
				...
				<div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate="El nombre es obligatorio">
					<input id="dir" class="input100" type="text" name="representanteLegal" placeholder="Representante Legal">
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>
				<div class="wrap-input100 rs2-wrap-input100 validate-input" data-validate="El telefono es obligatorio">
					<input class="input100" type="number" maxlength="10" name="telefonoRepresentante" placeholder="Teléfono representante" >
					<span class="focus-input100" style="border: 1px solid #000000"></span>
				</div>
...
if (isset($_POST["registrar"])) {
    ...
    if($control->insertar($proveedor)){
        echo "<script>alert('Datos ingresados con éxito')</script>";
        ?>
        <script>
        location.href="listar.proveedores.php";
        </script>
        <?php
    }
} else{
